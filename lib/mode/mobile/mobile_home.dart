...
import '../pc/assistanceChanger.dart';
import 'mobile_bottom_bar.dart';

class MobilePage extends StatefulWidget {
  MobilePage(this.number);
  double number = 0;
  @override
              ...
              children: <Widget>[
                      ...
                      child: Container(
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              width: size.width * 0.8057291666666667,
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                mainAxisAlignment:
                ...
                Stack(
                  children: <Widget>[
                    ...
                    Positioned(
                        top: size.width * 0.72,
                        left: size.width * 0.482,
                        child: Container(
                          width: size.width * 0.15,
                          child: Image.asset('images/12.png'),
                        )),
                    Positioned(
                      top: size.width * 0.155,
                      left: size.width * 0.1,
                      child: Container(
                                ...
                                Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      height: size.width * 0.0092,
                                      color: Colors.white,
                                    ),
                                    SizedBox(height: size.width * 0.0102),
                                    Container(
                                      width: size.width * 0.39,
                                                    ...
                                                    children: [
                                                      Container(
                                                          ...
                                                          height: size.width *
                                                              0.105,
                                                          child: AutoSizeText(
                                                            "Click on 'Register' button which is on the bottom left side of the dashboard.",
                                                            maxFontSize: 26,
                                                            minFontSize: 2,
                                                            style: GoogleFonts
                                                                .nunito(
      ...
      drawer: Drawer(
        child: Column(children: [
          ...
          TextButton(
              ...
              child: Text('HOME',
                  style: GoogleFonts.montserrat(color: Color(0xff410721)))),
          TextButton(
              onPressed: () async {
                scroll(1200);
